...
function ClientesLogin() {
  ...
  const handleLogin = () => {
    ...
    if (usuario === 'AdminClient01' && password === '141125') {
      ...
      alert('✅ Te amo demasiado no lo olvides bombis hermoso  ❤️')
      navigate('/clientes')
      return
    }
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <h2 style={styles.title}>Consulta tus clientes</h2>
        <p style={{ marginBottom: '15px', color: '#555', fontSize: '13px' }}>
          Ingresa usuario y contraseña para comenzar consultar o crear tus clientes
        </p>
